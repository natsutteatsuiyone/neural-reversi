...
const LEVELS: [Level; 22] = [
    ...
    Level { mid_depth: 16, end_depth: [23,23,23,23,23,23,23] },
    Level { mid_depth: 17, end_depth: [23,23,23,23,23,23,23] },
    Level { mid_depth: 18, end_depth: [24,24,24,24,24,24,24] },
    Level { mid_depth: 19, end_depth: [24,24,24,24,24,24,24] },
    Level { mid_depth: 20, end_depth: [25,25,25,25,25,25,25] },
    Level { mid_depth: 21, end_depth: [26,26,26,26,26,26,26] },
];
