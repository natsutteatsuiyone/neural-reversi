...
pub const UNIV_INPUT_OUTPUT_DIMS: usize = 160;

pub const L1_UNIV_INPUT_DIMS: usize = UNIV_INPUT_OUTPUT_DIMS;
...
pub const L2_INPUT_DIMS: usize = (L1_UNIV_OUTPUT_DIMS + L1_PA_OUTPUT_DIMS) * 2;
