...
export function GameModeSelector({ disabled }: GameModeSelectorProps) {
  ...
  const setAIAccuracyChange = useReversiStore((state) => state.setAIAccuracyChange);
  const showAISettings = gameMode === "ai-black" || gameMode === "ai-white";
    ...
    <div className="space-y-2">
      ...
      {showAISettings && (
        <div className="space-y-3 pt-3 border-white/10">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-medium text-white/90">Midgame Accuracy</h3>
